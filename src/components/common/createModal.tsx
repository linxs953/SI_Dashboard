  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* <Form.Item
          label={newModalFormSpec.itemLabel}
          name={newModalFormSpec.itemName}
          rules={[{ required: true, message: newModalFormSpec.itemErrorMsg }]}
          style={newModalFormSpec.itemStyle}
        >
          <Input />
        </Form.Item>
